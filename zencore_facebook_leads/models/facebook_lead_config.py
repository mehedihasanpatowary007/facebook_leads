...
class FacebookLeadConfig(models.Model):
    ...
    app_secret = fields.Char(groups="zencore_facebook_leads.group_facebook_lead_manager", copy=False)
    page_access_token = fields.Char(required=True, groups="zencore_facebook_leads.group_facebook_lead_manager", copy=False)
    verify_token = fields.Char(required=True, groups="zencore_facebook_leads.group_facebook_lead_manager", copy=False)
